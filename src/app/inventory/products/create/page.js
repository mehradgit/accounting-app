    ...
    <div className="container-fluid py-4">
      ...
      <nav aria-label="breadcrumb" className="mb-4">
        <ol className="breadcrumb">
          ...
          <li className="breadcrumb-item">
            <a href="/inventory/products" className="text-decoration-none">
      ...
      <div className="row align-items-center mb-4">
        <div className="col-md-6">
          <div className="d-flex align-items-center">
            ...
            <div>
              <h1 className="h3 fw-bold mb-1">افزودن کالای جدید</h1>
              <p className="text-muted mb-0">فرم ثبت اطلاعات کالا در سیستم انبارداری</p>
            </div>
          </div>
        </div>
        <div className="col-md-6">
              ...
              <div className="steps">
                <div className="step-item active">
                  ...
                  <div className="step-label">
                    ...
                    <div className="fw-medium">اطلاعات کالا</div>
                  </div>
                </div>
                <div className="step-item">
                  ...
                  <div className="step-label">
                    ...
                    <div className="fw-medium">تنظیم موجودی</div>
                  </div>
                </div>
                <div className="step-item">
                  <div className="step-progress">
          ...
          <div className="card border-0 bg-light h-100">
            <div className="card-body">
              <div className="d-flex">
                ...
                <div>
                  <h6 className="fw-bold mb-2">راهنمایی کد کالا</h6>
                  <p className="text-muted small mb-0">
                    کد کالا باید منحصر به فرد باشد. پیشنهاد می‌شود از ساختار کدینگ منطقی استفاده کنید.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="card border-0 bg-light h-100">
            <div className="card-body">
              <div className="d-flex">
                ...
                <div>
                  <h6 className="fw-bold mb-2">کنترل موجودی</h6>
                  <p className="text-muted small mb-0">
                    حداقل و حداکثر موجودی را با دقت تعیین کنید تا سیستم هشدارهای لازم را ارائه دهد.
                  </p>
                </div>
              </div>
            </div>
