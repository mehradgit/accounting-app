        ...
        <div className="col-md-6">
          <div className="d-flex align-items-center">
            <div className="bg-primary bg-gradient p-3 rounded-3 me-3">
              <i className="bi bi-building-add text-white fs-4"></i>
            </div>
            <div>
              <h1 className="h3 fw-bold mb-1">افزودن انبار جدید</h1>
              <p className="text-muted mb-0">فرم ثبت اطلاعات انبار در سیستم انبارداری</p>
            </div>
          </div>
        </div>
        <div className="col-md-6">
              ...
              <div className="steps">
                <div className="step-item active">
                  ...
                  <div className="step-label">
                    ...
                    <div className="fw-medium">اطلاعات انبار</div>
                  </div>
                </div>
                <div className="step-item">
                  ...
                  <div className="step-label">
                    ...
                    <div className="fw-medium">تنظیمات مالی</div>
                  </div>
                </div>
                <div className="step-item">
                  <div className="step-progress">
          ...
          <div className="card border-0 bg-light h-100">
            <div className="card-body">
              <div className="d-flex">
                ...
                <div>
                  <h6 className="fw-bold mb-2">راهنمایی کد انبار</h6>
                  <p className="text-muted small mb-0">
                    کد انبار باید منحصر به فرد باشد. پیشنهاد می‌شود از ساختار کدینگ منطقی استفاده کنید.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="card border-0 bg-light h-100">
            <div className="card-body">
              <div className="d-flex">
                ...
                <div>
                  <h6 className="fw-bold mb-2">حساب تفصیلی</h6>
                  <p className="text-muted small mb-0">
                    اتصال انبار به حساب تفصیلی برای ثبت خودکار تراکنش‌های حسابداری ضروری است.
                  </p>
                </div>
              </div>
            </div>
