...
export default function CreateProductCategoryPage() {
  ...
  useEffect(() => {
    ...
    const parentParam = urlParams.get('parentId');
    if (parentParam) {
          ...
          <div className="d-flex align-items-center">
            ...
            <div>
              <h1 className="h3 fw-bold mb-1">
                افزودن گروه کالای جدید
              </h1>
              <p className="text-muted mb-0">
                {parentId ? 'افزودن زیرگروه جدید' : 'تعریف گروه جدید برای دسته‌بندی کالاها'}
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="steps">
                <div className="step-item active">
                  ...
                  <div className="step-label">
                    ...
                    <div className="fw-medium">اطلاعات گروه</div>
                  </div>
                </div>
                <div className="step-item">
                  ...
                  <div className="step-label">
                    ...
                    <div className="fw-medium">تایید اطلاعات</div>
                  </div>
                </div>
                <div className="step-item">
                  <div className="step-progress">
                  ...
                  <div className="step-label">
                    ...
                    <div className="fw-medium">ثبت نهایی</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="card border-0 bg-light h-100">
            <div className="card-body">
              <div className="d-flex">
                ...
                <div>
                  <h6 className="fw-bold mb-2">راهنمایی کد گروه</h6>
                  <p className="text-muted small mb-0">
                    کد گروه باید منحصر به فرد باشد. پیشنهاد می‌شود از ساختار کدینگ منطقی استفاده کنید.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="card border-0 bg-light h-100">
            <div className="card-body">
              <div className="d-flex">
                ...
                <div>
                  <h6 className="fw-bold mb-2">ساختار درختی</h6>
                  <p className="text-muted small mb-0">
                    می‌توانید گروه‌ها را به صورت درختی سازماندهی کنید. هر گروه می‌تواند زیرگروه داشته باشد.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="card-body">
              <div className="d-flex">
                ...
                <div>
                  ...
                  <p className="text-muted small mb-0">
                    در صورت نیاز به راهنمایی، با واحد فنی تماس بگیرید.
